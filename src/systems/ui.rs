...
pub struct HudParams<'w, 's> {
    ...
    pub ship_query: Query<'w, 's, &'w mut Ship, (With<PlayerShip>, Without<AutonomousShipTag>, Without<Station>)>,
    pub station_query: Query<'w, 's, (Entity, &'w mut Station, &'w mut StationQueues), (With<Station>, Without<Ship>, Without<AutonomousShipTag>)>,
    ...
    pub cam_query: Query<'w, 's, &'w mut OrthographicProjection, With<MainCamera>>,
}
