...
pub const REFINERY_MAGNETITE_TIME: f32 = 8.0;
pub const REFINERY_CARBON_TIME: f32 = 12.0;
pub const FORGE_HULL_TIME: f32 = 20.0;
pub const FORGE_CORE_TIME: f32 = 30.0;
...
pub const SHIP_POWER_COST_TRANSIT: f32 = 0.0;  // disabled until Helium Fuel Cells implemented
