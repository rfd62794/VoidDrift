...
|---|---|
| **CHASSIS** (port unchanged) | `autopilot.rs`, `viewport.rs`, `visuals/mesh_builder.rs`, `persistence/io.rs`, `persistence/save.rs`, `telemetry/mod.rs`, `visuals/debug_log.rs`, `scenes/menu_starfield.rs`, `ui_kit/primitives.rs`, `ui_kit/styles.rs`, `config/mod.rs` |
| **RESKIN** (structure kept, content replaced) | `lib.rs`, `constants.rs`, `components/markers.rs`, `components/ui_state.rs`, `components/utilities.rs`, `config/balance.rs`, `config/visual.rs`, `game_loop/autonomous.rs`, `ship_control/ship_spawn.rs`, `narrative/content_router.rs`, `ui/hud/mod.rs`, `ui/hud/buttons.rs`, `ui/hud/overlays.rs`, `ui/hud/state_machine.rs`, `ui/tutorial.rs`, `visuals/visuals.rs`, `visuals/map.rs`, `persistence/systems.rs`, `scenes/main_menu.rs` |
